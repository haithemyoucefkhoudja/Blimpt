...
function MainComponent({
  ...
  return (
    ...
    >
      <div
        className="flex flex-col items-center gap-2 h-full justify-end mt-auto"
        data-tauri-drag-region
      >
        <WebSearchIndicator
          activeWindow={ActiveWindow}
          setActiveWindow={() => setActiveWindow("commands")}
        />
        <HistoryIndicator
          activeWindow={ActiveWindow}
          setActiveWindow={() => setActiveWindow("history")}
        />
        <ChatIndicator
          activeWindow={ActiveWindow}
          setActiveWindow={() => setActiveWindow("chat")}
        />
        <ExpandIndicator
          activeWindow={ActiveWindow}
          setActiveWindow={() => setActiveWindow("list")}
        />
      </div>
