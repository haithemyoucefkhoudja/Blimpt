...
export default function WebSearchIndicator({ activeWindow, setActiveWindow }: WebSearchIndicatorProps) {
  ...
  return (
    <Button onClick={handleClick} variant='ghost' type="button" size="icon" className={cn("rounded-full relative ", activeWindow === "commands" ? "bg-accent" : "")}>
      <span 
        className={cn("absolute top-0 right-0 h-3 w-3 rounded-full ", isOn ? "bg-green-400" : "bg-red-400 animate-bounce")}
      />
